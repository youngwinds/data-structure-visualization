const home = [
  {
    key: 'Title',
    'zh-CN': '数据结构可视化',
    'en-US': 'Data Structure Visualization',
  },
  {
    key: 'Subtitle',
    'zh-CN': '有限的数据结构与无限的算法.',
    'en-US': 'Finite Data Structures and Infinite Algorithms.',
  },
  {
    key: 'Goal',
    'zh-CN': '设计目标',
  ...
  },
  {
    key: 'GoalContent',
    'zh-CN':
      '我的主要目标是算法可视化，但是要将算法的执行过程可视化并非一件简单的事，我尝试寻找一种通用解决方法。经过大量的探索后，突然在那么一天，我悟了！要将算法可视化则必然要将该算法依赖的数据结构可视化！',
    'en-US':
  ...
  {
    key: 'PrecautionsContent',
    'zh-CN':
      '由于项目依然在起步阶段，代码结构的设计、图表的接口还未彻底固定，完整并且具体的文档以及接口我会在正式发布后一起提供。',
    'en-US':
      'Since the project is still in its infancy, the design of the code structure and the interface of the diagram have not been completely fixed. I will provide this whole specific documents and interfaces after the official release.',
  },
];
